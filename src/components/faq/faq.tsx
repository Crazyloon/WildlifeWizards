    ...
    <>
      ...
      >
        <Accordion.Item value="q-1">
          ...
          <AccordionContent>
            We handle all authorized wildlife species including raccoons,
            squirrels, bats, beavers (both mountain and regular) chipmunks,
            opossums, all manner of birds, snakes, rats, mice, weasels, otters,
            nutria, moles, voles, bobcats, and coyotes. Call if you don&apos;t
            see your animal on the list.
          </AccordionContent>
        </Accordion.Item>
